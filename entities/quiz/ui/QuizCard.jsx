  ...
  return (
    <div style={{
      ...
      <h3 style={{fontSize:18, margin:0}}>
        <Link href={/fun/quiz/} style={{textDecoration:'none', color:'inherit'}}>
          {title}
        </Link>
      </h3>
      ...
      <div style={{marginTop:12}}>
        <Link href={/fun/quiz/} style={{
          display:'inline-block', padding:'8px 12px', borderRadius:8, border:'1px solid #e5e7eb'
        }}>
          시작하기
        </Link>
      </div>
